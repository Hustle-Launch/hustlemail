...
const mockMessages: Message[] = [
  {
    ...
    to: [{ address: "team@hustlemail.dev" }],
  ...
  },
  {
    ...
    to: [{ address: "team@hustlemail.dev" }],
    subject: "Deployment successful: hustlemail-web",
    snippet: "Your deployment is live at hustlemail.dev. Build time: 23s...",
    bodyText: "Your deployment is live!\n\nProject: hustlemail-web\nURL: https://hustlemail.dev\nBuild time: 23s\nRegion: iad1",
  ...
  },
  {
    ...
    to: [{ address: "support@hustlemail.dev" }],
